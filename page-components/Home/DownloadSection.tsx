...
import heroImageTwo from '/public/assets/mobile-front-stack.png'
    ...
    <div className='bg-dullOrange'>
      <section className='container mx-auto py-6 md:py-24'>
        <div className='grid grid-rows-[max-content_1fr] grid-cols-1 md:grid-rows-1 md:grid-cols-[1fr_2fr] gap-10 md:gap-3'>
          <div className='relative w-full h-[600px] md:h-[680px] rounded-sm order-last md:order-first'>
            <Image src={heroImageTwo} alt={'hero'} layout={'fill'} className={'object-contain object-center rounded-sm z-0'} />
          </div>
