export const ActiveBreakpointIndicator = (): JSX.Element => {
  return (
    <div className='fixed top-0 right-0 z-[9999] m-8 flex h-6 w-6 items-center justify-center rounded-full bg-gray-700 p-3 font-mono text-xs text-white sm:bg-pink-500 md:bg-orange-500 lg:bg-green-500 xl:bg-blue-500'>
